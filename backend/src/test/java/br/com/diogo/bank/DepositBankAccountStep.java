...
public class DepositBankAccountStep {
    ...
    public void requestDepositAmount() throws Exception {
        MvcResult result = mockMvc.perform(MockMvcRequestBuilders.patch("/bank-accounts/deposit/" + this.bankAccount.getId())
